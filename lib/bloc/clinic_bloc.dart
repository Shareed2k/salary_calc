...
class ClinicBloc {
  Clinic
      initialClinic; //if the data is not passed by paramether it initializes with 0
  BehaviorSubject<Clinic> _subjectClinic;

  ClinicBloc({this.initialClinic}) {
    _subjectClinic = BehaviorSubject<Clinic>.seeded(
        this.initialClinic); //initializes the subject with element already
  }
